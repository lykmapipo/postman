  ...
  try {
    ...
    async.waterfall([
      ...
      function send(next) {
        ...
        transport.send(this, function (error /*, sent*/ ) {

          //prepare result
          let _result = _.merge({}, this.result);
...
MessageSchema.methods.send = function send(done) {
  ...
  /* @todo todo format to based on message type */
  /* @todo todo compact & ensure uniq receiver */
  /* @todo todo lower case emails */
  /* @todo todo e164 phone numbers */
