...
/* @todo load transports */
/* @todo per channel create processor with concurrency */
...
// const WORKER_CONCURRENCY = (process.env.WORKER_CONCURRENCY || 10);
// const transports = require('require-all')({
//   dirname: path.join(__dirname, 'transports'),
//   excludeDirs: /^\.(git|svn)$/,
//   recursive: true
// });
